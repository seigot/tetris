...
| 基準点とそれ以外の座標 | (x-2,y),(x-1,y),(x,y),(x+1,y) | (x-1,y),(x,y),(x+1,y),(x-1,y+1) | (x-1,y-1),(x-1,y),(x,y),(x+1,y) | (x-1,y),(x,y),(x+1,y),(x,y+1) | --- | (x,y-1),(x,y),(x+1,y),(x+1,y+1) | (x+1,y-1),(x,y),(x+1,y),(x,y+1) | 
